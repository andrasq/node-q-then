...
P.resolve = function resolve( v ) {
    ...
    if (typeof v === 'function') {
        return __resolve(__getFunctionValue(v, p), p, _RESOLVED);
    }
    return __resolve(v, p, _RESOLVED);
}

P.reject = function reject( e ) {
    var p = new P();
    if (typeof e === 'function') {
        return __resolve(__getFunctionValue(e, p), p, _REJECTED);
    }
    return __resolve(e, p, _REJECTED);
}
...
function _tryExecutor( p1, resolver ) {
    try {
        resolver(function(v) { __resolve(v, p1, _RESOLVED) }, function(e) { __resolve(e, p1, _REJECTED) })
    }
    catch (e) {
        __resolve(e, p1, _REJECTED);
    }
}
...
P.prototype._resolve = function _resolve( v ) {
    __resolve(v, this, _RESOLVED);
}
P.prototype._reject = function _reject( e ) {
    __resolve(e, this, _REJECTED);
}
...
function __settle( v, p, state ) {
    switch (state) {
    case _RESOLVED: __settleYes(v, p); break;
    case _REJECTED: __settleNo(v, p); break;
    }
}
