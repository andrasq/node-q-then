...
// convert the promise constructor into a callbacked function
// The callback will be called when the promise represented by the executor settles.
P.callbackify = function callbackify( executor, cb ) {
    // TODO: optimize
    var p1 = new P(executor);
    return P.callback(p1);
}
...
function _handleThen( handler, v, p2, state, pBy ) {
    ...
    else process.nextTick(__settle, v, p2, state);
}
